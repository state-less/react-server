...
import { EVENT_STATE_ERROR, EVENT_STATE_USE, EVENT_STATE_SET, EVENT_STATE_PERMIT, EVENT_STATE_CREATE, EVENT_STATE_REQUEST, EVENT_SCOPE_CREATE, EVENT_STATE_DECLINE, SERVER_ID } from '../../consts'
...
class SocketIOBroker extends Broker {
    ...
    sync(state, socket, ...args) {
        ...
        const syncObject = {
            id, value, error: error ? { message, stack } : null
        };
