...
var Transport = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Transport, [{
    ...
    key: "deleteState",
    value: function deleteState(state) {
      throw new Error('Not implemented');
    }
  }]);
  return Transport;
...
var PostgresTransport = /*#__PURE__*/function (_Transport) {
  ...
  (0, _createClass2["default"])(PostgresTransport, [{
    ...
    key: "deleteState",
    value: function () {
      var _deleteState = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(state) {
        var _this3 = this;
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              query = "DELETE FROM states WHERE ".concat(where);
              retries = 0;
              _context4.prev = 4;
              _context4.next = 7;
            ...
            case 12:
              ...
              return _context4.abrupt("return", new Promise(function (resolve) {
                console.error("Error deleting state ".concat(key, ". Retrying..."));
                  ...
                  return _regenerator["default"].wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _context3.next = 3;
                        return _this3.deleteState(state);
                      case 3:
    ...
    key: "setInitialState",
    value: function () {
      var _setInitialState = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(state) {
        var _this4 = this;
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 11:
              ...
              console.error('Error setting initial state:', _context6.t0.message);
              if (!(retries < 3)) {
                _context6.next = 19;
                break;
              }
    ...
    key: "getState",
    value: function () {
      var _getState = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(state) {
        var _this5 = this;
        var scope, key, uuid, where, query, retries, result;
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 10:
              return _context8.abrupt("return", result[0].value);
            case 13:
              _context8.prev = 13;
    ...
    key: "queryByOptions",
    value: function () {
      var _queryByOptions = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(stateOptions, retries) {
        var _this6 = this;
